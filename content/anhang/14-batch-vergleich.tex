\TodoW{Kitt der Anhänge mit Auswertungen}

\anhang{Amazon Timestream}\label{anhang:vergleich-timestream}
...
\anhang{Amazon Athena/Amazon S3}\label{anhang:vergleich-athena}
\anhangteil{Features des Dienstes}
...
\anhang{Amazon Redshift}\label{anhang:vergleich-redshift}
...
\anhang{Amazon OpenSearch Service}\label{anhang:vergleich-opensearch}
\anhangteil{Features des Dienstes}
...
Mithilfe der \enquote{Percentiles aggregation} können beliebige Perzentile eines Datensatzes berechnet werden. Dies wird in \autoref{listing:percentiles-elasticsearch} im \anhangref{anhang:elastic-code} mit der Elasticsearch eigenen Abfragesprache gezeigt. 
