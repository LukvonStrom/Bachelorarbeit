\anhang{AWS IoT Events}\label{anhang:vergleich-iot-events}
...
\anhang{Amazon Kinesis}\label{anhang:vergleich-kinesis}
...
\anhang{AWS Lambda}\label{anhang:vergleich-lambda}
\anhangteil{Features des Dienstes}
...
\anhang{Amazon MSK / ksqlDB}\label{anhang:vergleich-msk}
\anhangteil{Features des Dienstes}
