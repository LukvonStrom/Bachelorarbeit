Aufgrund der hohen Popularität der $\lambda$-Architektur, gibt es Dienste, die sowohl Echtzeitverarbeitung, als auch Batch/\ac{OLAP}-Verarbeitung unterstützen. Im \ac{AWS} Portfolio ist dieser Dienst \AWSIOT{} Analytics, welcher im Folgenden beleuchtet wird.
