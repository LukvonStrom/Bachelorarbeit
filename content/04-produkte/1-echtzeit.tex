...
Die Performance und Verfügbarkeit sowie die Features werden in \anhangref{anhang:vergleich-iot-events} diskutiert.
...
\subsubsection{Weitere Evaluationen}
Die Performance und Verfügbarkeit sowie die Features werden in \anhangref{anhang:vergleich-kinesis} diskutiert.
...
\subsubsection{Weitere Evaluationen}
Die Performance und Verfügbarkeit sowie die Features werden in \anhangref{anhang:vergleich-lambda} diskutiert.
...
\subsubsection{Weitere Evaluationen}
Die Performance und Verfügbarkeit sowie die Features werden in \anhangref{anhang:vergleich-msk} diskutiert.
