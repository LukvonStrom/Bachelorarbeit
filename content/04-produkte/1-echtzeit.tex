...
\end{listing}
Alle Attribute jeder Nachricht aus dem Topic iot-demo-sensor werden dabei selektiert und können dann z.B. weitergeleitet werden.
...
Siehe \footcite[Vgl.][]{AmazonWebServicesInc..o.J.l}\nzitat\footcite[Vgl.][]{AmazonWebServicesInc..o.J.m}\nzitat\footcite[Vgl.][]{AmazonWebServicesInc..2017b}
...
\ac{S3}-Speicher & 0,0245/GB Speicher & 0,0006 \\ \hline
\ac{SNS} (Push) & \begin{tabular}[c]{@{}l@{}}0,00002/Nachricht\\ (angenommen 5 Alarme/Gerät/Monat)\end{tabular} & 0,02 \\
