...
\autoref{tab:bewertungsmatrix-AWS~IoT~Analytics}
...
1 & AWS IoT Analytics & \cellcolor[HTML]{DAE8FC}57 \\ \hline
2 & AWS Lambda & \cellcolor[HTML]{DAE8FC}52 \\ \hline
3 & AWS Glue & \cellcolor[HTML]{DAE8FC}49 \\ \hline
4 & Amazon MSK & \cellcolor[HTML]{DAE8FC}48 \\ \hline
5 & AWS IoT Events & \cellcolor[HTML]{DAE8FC}47 \\ \hline
6 & Amazon Kinesis & \cellcolor[HTML]{DAE8FC}46 \\ \hline
\end{tabular}
