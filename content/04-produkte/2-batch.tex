...
Die Performance und Verfügbarkeit sowie die Features werden in \anhangref{anhang:vergleich-timestream} diskutiert.
...
\subsubsection{Weitere Evaluationen}
Die Performance und Verfügbarkeit sowie die Features werden in \anhangref{anhang:vergleich-athena} diskutiert.
...
Zusätzlich müssen Lambda Ausführungen dazu gerechnet werden, die die hinterlegten \ac{SQL} Abfragen ausführen und je nach Resultat \ac{SNS} benachrichtigen.
...
\subsubsection{Weitere Evaluationen}
Die Performance und Verfügbarkeit sowie die Features werden in \anhangref{anhang:vergleich-redshift} diskutiert.
...
\subsubsection{Weitere Evaluationen}
Die Performance und Verfügbarkeit sowie die Features werden in \anhangref{anhang:vergleich-opensearch} diskutiert.
