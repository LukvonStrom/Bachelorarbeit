\begin{table}[H]
    ...
    \hline
\multicolumn{1}{|c|}{Kriterium} & \multicolumn{1}{c!{\vrule width 2pt}}{\begin{tabular}[c]{@{}c@{}}max.\\Punkte\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}X\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Y\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Z\end{tabular}} \\ \hline
     ...
     Summe & 66 & \cellcolor[HTML]{ECF4FF}0 & \cellcolor[HTML]{ECF4FF}0 & \cellcolor[HTML]{ECF4FF}0 \\ \hline
\end{tabular}
