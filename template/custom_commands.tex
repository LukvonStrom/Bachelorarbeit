...
\newcommand{\minianhangabschnitt}[3]{
% \pdfbookmark[3]{#1 von #2}{miniabschnitt:anhang-#1-#2}
\textbf{#1 von #2}\label{#3-mas}\hfill\break\noindent
}

\newcommand{\ftanhang}[1]{
\anhangteil{#1}\label{anhang:vergleich-#1} 
\textbf{Features von #1}\label{anhang:vergleich-features-#1}\hfill\break\noindent
}

\newcommand{\dlanhang}[1]{
\textbf{Dienstleistungsumfang von #1}\label{anhang:vergleich-umfang-#1}\hfill\break\noindent
}
