...
\newcommand{\minianhangabschnitt}[2]{
% \pdfbookmark[3]{#1 von #2}{miniabschnitt:anhang-#1-#2}
\textbf{#1 von #2}\hfill\break\noindent
}

\newcommand{\ftanhang}[1]{
\anhangteil{#1}\label{anhang:vergleich-#1} 
\minianhangabschnitt{Features}{#1}\label{anhang:vergleich-features-#1}}

\newcommand{\dlanhang}[1]{
\minianhangabschnitt{Dienstleistungsumfang}{#1}\label{anhang:vergleich-umfang-#1}
}
