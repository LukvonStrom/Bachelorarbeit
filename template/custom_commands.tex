...
% \begin{tabular}{|l|l|l|}
% \hline
% \multicolumn{1}{|c|}{Kriterium} & \multicolumn{1}{c|}{Priorität} & \multicolumn{1}{c|}{#1} \\ \hline
...
% In \autoref{tab:bewertungsmatrix-#1} wird #1 gemäß der in \autoref{tab:einstufungen} eingeschränkten Bewertungen bewertet.
% }

% \renewcommand{\clearpage}{}
\renewcommand*{\lstlistingname}{Codebeispiel}

%from https://groups.google.com/g/comp.text.tex/c/dOHk1iL9VKs/m/z7Yl8Kd0NUoJ
\makeatletter
\def\hlinewd#1{%
